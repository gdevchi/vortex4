...
const waitlistServices = require("../services/waitlist.services");

const MAX_ROOM_LIMIT = process.env.MAX_ROOM_LIMIT || 12;
...
exports.isRoomFull = async function (req, res, next) {
  //GET COUNT FROM SOCKET BECAUSE IT UPDATED FASTER THAN DB
